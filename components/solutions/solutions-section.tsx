      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <Link href="/solutions/smes" className="inline-flex items-center text-blue-600 hover:text-blue-800">
              Learn more
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <Link href="/solutions/enterprise" className="inline-flex items-center text-blue-600 hover:text-blue-800">
              Learn more
              <ChevronRight className="ml-1 h-4 w-4" />
            </Link>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <Link href="/solutions/individual" className="inline-flex items-center text-blue-600 hover:text-blue-800">
              Learn more
              <ChevronRight className="ml-1 h-4 w-4" />
            </Link>
          </div>
