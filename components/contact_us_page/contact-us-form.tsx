  ...
  return (
    <>
      ...
      <section
        ...
        className="block md:hidden bg-[#E8F0FF] py-6 px-4 rounded-2xl max-w-md mx-auto shadow-md"
      >
        <form
          onSubmit={handleSubmit}
          className="space-y-4 bg-white p-4 rounded-[15px]"
        >
          <div>
          ...
          <div>
            <label htmlFor="solution" className="text-sm font-bold text-black">
              Which of our solutions interests you?
            </label>
            <p className="text-xs text-gray-500 mt-1 mb-2">
              Choose one so we can assist you better.
            </p>
            <select
              id="solution"
              name="solution"
          ...
          <div>
            <h3 className="font-bold mb-4 mt-8 px-2 text-[16px]">
              Let's Make Payments Work for You
            </h3>
            <p className="text-xs text-gray-500 mb-8 px-2 text-[14px]">
              By clicking below, you agree to 3Line's Terms & Conditions and
              Privacy Policy.
            </p>
            <button
              type="submit"
      ...
      <section
        ...
        className=" hidden md:block py-12 px-4 bg-[#EEF3FF] "
      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white pt-6 rounded-xl shadow-sm order-2 md:order-1">
                  <form className="space-y-4 " onSubmit={handleSubmit}>
                    ...
                    {/* CTA */}
                    <div>
                      <h3 className="font-bold mb-4 mt-8 px-8">
                        Let's Make Payments Work for You
                      </h3>
                      <p className="text-xs text-gray-500 mb-8 px-8">
                        By clicking below, you agree to 3Line's Terms &
