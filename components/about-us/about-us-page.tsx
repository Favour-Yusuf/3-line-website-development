      ...
      <main className="pl-[25px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-3 md:mx-4 md:mb-[200px]">
              ...
              <div className="mr-[20px] border-r border-blue-500 h-[300px]">
                <h2 className="text-[28px] leading-tight font-bold mb-4 text-[#10142C]">
                  At 3Line, <br /> we believe everyone deserves access to <br />{" "}
                  financial services, regardless of location or background
                </h2>
                <p className="text-gray-800 text-[22px]  mb-11">
                  Since 2017, we've been bridging financial gaps with
              ...
              <div className="mt-[200px] ml-[20px]">
                <h2 className="text-[40px] font-bold mb-4 text-[#10142C] ">
                  Our story
                </h2>
                <p className="text-black text-[22px] mb-6">
                  ...
                  to make financial services more accessible for everyone.
                  Today, we're proud to be a trusted partner for banks,
                  fintechs, and businesses across Nigeria and beyond.
                </p>
        ...
        <section className="relative bg-[#EEF3FF] overflow-hidden">
          <div className="container mx-auto px-6 md:px-8 py-8 md:py-12 relative z-10">
            <div className="bg-[#10142C]  rounded-xl overflow-hidden mx-3 md:mx-1">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6  pl-8 md:pl-12">
                <div className="text-white md:pt-[70px] md:pl-[50px]">
                  ...
                  <p className="text-gray-300 lg:text-[22px] max-w-xl">
                    ...
                    to financial tools and integrated payment solutions, we
                    share this.
                  </p>
                </div>
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mx-3 md:mx-4">
              <div className="bg-white p-6 rounded-xl shadow-sm relative h-[350px]">
                ...
                <div className="mb-2">
                  <span className="text-black text-[20px] inline-block bg-[#00D2FF] md:px-3 md:py-1 rounded-md font-bold rotate-[-15deg]">
                    For
                  </span>
                  <h3 className="text-[28px] font-bold text-[#10142C]">SMEs</h3>
                </div>
                <p className="text-gray-600 mb-6 text-[15px]">
                  Get paid faster, access digital banking, and manage
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm relative h-[350px]">
                ...
                <div className="mb-2">
                  ...
                  <h3 className="text-[28px] font-bold text-[#10142C]">
                    Enterprises
                  </h3>
                </div>
                <p className="text-gray-600 mb-6 text-[15px]">
                  Optimize cash flow with secure, efficient, and scalable
                  payment solutions.
                </p>
                <div className="w-[95%] flex justify-end items-end absolute top-[80%]">
                  <Link
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm relative h-[350px]">
                ...
                <p className="text-gray-600 mb-6 text-[15px]">
                  Expand banking services to the unbanked and underserved
                  communities.
                </p>
                <div className="w-[95%] flex justify-end items-end absolute top-[80%]">
                  <Link
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm relative h-[350px]">
                ...
                <p className="text-gray-600 mb-6 text-[15px]">
                  Create financial access points where they are needed most.
                </p>
                <div className="w-[95%] flex justify-end items-end absolute top-[80%]">
                  <Link
                    href="#"
        ...
        <section className="py-8 px-4 bg-[#EEF3FF]">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mx-3 md:mx-4">
              {/* Why Choose Us */}
              <div>
                <h2 className="text-2xl font-bold text-[#10142C] mb-5">
                  Why Choose Us?
                </h2>
                <div className="space-y-4">
                  <div className="bg-white p-5 rounded-xl shadow-sm">
                    <h3 className="text-lg font-semibold text-[#10142C] mb-1.5">
                      Innovation
                    </h3>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      We're constantly pushing boundaries to deliver
                  ...
                  <div className="bg-white p-5 rounded-xl shadow-sm ">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      We're committed to bringing financial services to the
