                ...
                <div className="absolute left-0 mt-2 w-[250px] bg-white rounded-xl shadow-lg overflow-hidden z-50">
                  <div className="p-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <Link href="/careers" className="block p-4 hover:bg-[#F5F8FF] rounded-lg">
                        Careers
                      </Link>
                      <Link href="/contact-us" className="block p-4 hover:bg-[#F5F8FF] rounded-lg">
                        Contact Us
                      </Link>
                      <Link href="/partners" className="block p-4 hover:bg-[#F5F8FF] rounded-lg">
                        Our Partners
                      </Link>
                    </div>
                  </div>
              ...
              {activeDropdown === "resources" && (
                <div className="absolute left-0 mt-2 w-[250px] bg-white rounded-xl shadow-lg overflow-hidden z-50">
                  <div className="p-2">
                    ...
                    <div className="space-y-1">
                      <Link href="/blog" className="block p-4 hover:bg-[#F5F8FF] rounded-lg">
                        Blog
                      </Link>
                      <Link href="/press" className="block p-4 hover:bg-[#F5F8FF] rounded-lg">
                        Press
                      </Link>
                      <Link href="/case-studies" className="block p-4 hover:bg-[#F5F8FF] rounded-lg">
                        Case Studies
                      </Link>
                      <Link href="/api" className="block p-4 hover:bg-[#F5F8FF] rounded-lg">
                        APIs
                      </Link>
                      <Link href="/faq" className="block p-4 hover:bg-[#F5F8FF] rounded-lg">
                        FAQs
                      </Link>
                    </div>
                  </div>
